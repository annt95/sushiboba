...
(function (AdminTemplate) {
    ...
    })(Administration = AdminTemplate.Administration || (AdminTemplate.Administration = {}));
...
(function (AdminTemplate) {
    ...
    })(BasicSamples = AdminTemplate.BasicSamples || (AdminTemplate.BasicSamples = {}));
})(AdminTemplate || (AdminTemplate = {}));
var AdminTemplate;
(function (AdminTemplate) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = AdminTemplate.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = AdminTemplate.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = AdminTemplate.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (AdminTemplate) {
    ...
    })(Common = AdminTemplate.Common || (AdminTemplate.Common = {}));
})(AdminTemplate || (AdminTemplate = {}));
var AdminTemplate;
(function (AdminTemplate) {
    var Common;
...
(function (AdminTemplate) {
    ...
    })(Membership = AdminTemplate.Membership || (AdminTemplate.Membership = {}));
})(AdminTemplate || (AdminTemplate = {}));
var AdminTemplate;
(function (AdminTemplate) {
    var Membership;
...
(function (AdminTemplate) {
    ...
    })(Northwind = AdminTemplate.Northwind || (AdminTemplate.Northwind = {}));
})(AdminTemplate || (AdminTemplate = {}));
var AdminTemplate;
(function (AdminTemplate) {
    var Northwind;
...
(function (AdminTemplate) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'AdminTemplate.Northwind.Gender', 'AdminTemplate.Northwind.Entities.Gender');
    })(Northwind = AdminTemplate.Northwind || (AdminTemplate.Northwind = {}));
})(AdminTemplate || (AdminTemplate = {}));
var AdminTemplate;
(function (AdminTemplate) {
...
(function (AdminTemplate) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = AdminTemplate.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = AdminTemplate.LanguageList || (AdminTemplate.LanguageList = {}));
})(AdminTemplate || (AdminTemplate = {}));
...
(function (AdminTemplate) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('AdminTemplate');
        Serenity.EntityDialog.defaultLanguageList = AdminTemplate.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = AdminTemplate.ScriptInitialization || (AdminTemplate.ScriptInitialization = {}));
})(AdminTemplate || (AdminTemplate = {}));
var AdminTemplate;
(function (AdminTemplate) {
    var Administration;
...
(function (AdminTemplate) {
    ...
    AdminTemplate.BasicProgressDialog = BasicProgressDialog;
})(AdminTemplate || (AdminTemplate = {}));
var AdminTemplate;
(function (AdminTemplate) {
    var Common;
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new AdminTemplate.BasicProgressDialog();
...
(function (AdminTemplate) {
    ...
    })(DialogUtils = AdminTemplate.DialogUtils || (AdminTemplate.DialogUtils = {}));
})(AdminTemplate || (AdminTemplate = {}));
var AdminTemplate;
(function (AdminTemplate) {
    var Common;
...
(function (AdminTemplate) {
    ...
    AdminTemplate.StaticTextBlock = StaticTextBlock;
})(AdminTemplate || (AdminTemplate = {}));
var AdminTemplate;
(function (AdminTemplate) {
    var Common;
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                AdminTemplate.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (Northwind) {
        var CustomerGrid = /** @class */ (function (_super) {
            ...
            CustomerGrid.prototype.getButtons = function () {
                ...
                buttons.push(AdminTemplate.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    service: 'Northwind/Customer/ListExcel',
                    separator: true
                }));
                buttons.push(AdminTemplate.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); }
                }));
                return buttons;
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(AdminTemplate.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
                    cssClass: 'export-pdf-button',
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        AdminTemplate.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: AdminTemplate.Authorization.userDefinition.DisplayName,
...
(function (AdminTemplate) {
    ...
    (function (Northwind) {
        ...
        }(AdminTemplate.Common.GridEditorDialog));
...
(function (AdminTemplate) {
    ...
    (function (Northwind) {
        ...
        }(AdminTemplate.Common.GridEditorBase));
    ...
    (function (Northwind) {
        var RegionDialog = /** @class */ (function (_super) {
            ...
            RegionDialog.prototype.getLanguages = function () {
                return AdminTemplate.LanguageList.getValue();
            };
...
(function (AdminTemplate) {
    ...
    })(Authorization = AdminTemplate.Authorization || (AdminTemplate.Authorization = {}));
})(AdminTemplate || (AdminTemplate = {}));
var AdminTemplate;
(function (AdminTemplate) {
    var BasicSamples;
...
(function (AdminTemplate) {
    ...
    (function (BasicSamples) {
        ...
        }(AdminTemplate.Northwind.ProductDialog));
...
(function (AdminTemplate) {
    ...
    (function (BasicSamples) {
        ...
        }(AdminTemplate.Northwind.ProductGrid));
...
(function (AdminTemplate) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: AdminTemplate.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: AdminTemplate.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new AdminTemplate.Northwind.OrderDialog();
                        ...
                        var chai = AdminTemplate.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = AdminTemplate.Northwind.EmployeeRow.getLookup().items
        ...
        }(AdminTemplate.Northwind.OrderGrid));
...
(function (AdminTemplate) {
    ...
    (function (BasicSamples) {
        ...
        }(AdminTemplate.Northwind.OrderDialog));
...
(function (AdminTemplate) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    AdminTemplate.Northwind.CategoryService.Retrieve({
        ...
        }(AdminTemplate.Northwind.CategoryDialog));
...
(function (AdminTemplate) {
    ...
    (function (BasicSamples) {
        ...
        }(AdminTemplate.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(AdminTemplate.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new AdminTemplate.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                AdminTemplate.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(AdminTemplate.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    AdminTemplate.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(AdminTemplate.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(AdminTemplate.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    AdminTemplate.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return AdminTemplate.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return AdminTemplate.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return AdminTemplate.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return AdminTemplate.Northwind.OrderService.baseUrl; };
...
(function (AdminTemplate) {
    ...
    (function (BasicSamples) {
        ...
        }(AdminTemplate.Northwind.SupplierDialog));
...
(function (AdminTemplate) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(AdminTemplate.Northwind.SupplierGrid));
...
(function (AdminTemplate) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return AdminTemplate.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return AdminTemplate.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return AdminTemplate.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return AdminTemplate.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return AdminTemplate.Northwind.OrderService.baseUrl; };
...
(function (AdminTemplate) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    AdminTemplate.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(AdminTemplate.Northwind.CustomerDialog));
...
(function (AdminTemplate) {
    ...
    (function (BasicSamples) {
        ...
        }(AdminTemplate.Northwind.CustomerGrid));
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = AdminTemplate.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return AdminTemplate.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return AdminTemplate.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new AdminTemplate.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(AdminTemplate.Northwind.OrderDetailDialog));
...
(function (AdminTemplate) {
    ...
    (function (BasicSamples) {
        ...
        }(AdminTemplate.Northwind.OrderDetailsEditor));
...
(function (AdminTemplate) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return AdminTemplate.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return AdminTemplate.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return AdminTemplate.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return AdminTemplate.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return AdminTemplate.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (AdminTemplate) {
    ...
    (function (BasicSamples) {
        ...
        }(AdminTemplate.Common.BulkServiceAction));
...
(function (AdminTemplate) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return AdminTemplate.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return AdminTemplate.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return AdminTemplate.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return AdminTemplate.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(AdminTemplate.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new AdminTemplate.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new AdminTemplate.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new AdminTemplate.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (AdminTemplate) {
    ...
    AdminTemplate.SelectableEntityGrid = SelectableEntityGrid;
})(AdminTemplate || (AdminTemplate = {}));
...
(function (AdminTemplate) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return AdminTemplate.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return AdminTemplate.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return AdminTemplate.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return AdminTemplate.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(AdminTemplate.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = AdminTemplate.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            AdminTemplate.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (AdminTemplate) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return AdminTemplate.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return AdminTemplate.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return AdminTemplate.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return AdminTemplate.Northwind.ProductService.baseUrl; };
...
(function (AdminTemplate) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return AdminTemplate.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return AdminTemplate.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return AdminTemplate.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return AdminTemplate.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (AdminTemplate) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return AdminTemplate.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return AdminTemplate.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (AdminTemplate) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return AdminTemplate.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return AdminTemplate.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return AdminTemplate.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
//# sourceMappingURL=AdminTemplate.Web.js.map